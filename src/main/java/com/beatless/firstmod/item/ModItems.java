...
public class ModItems {
    ...
    public static final RegistryObject<Item> Lava_Shard = Items.register("ore/lava_shard", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> Ice_Shard = Items.register("ore/ice_shard", () -> new Item(new Item.Properties()));
