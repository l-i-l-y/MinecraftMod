...
public class ModCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> ORE_TAB =
            CREATIVE_MODE_TABS.register("ore", () -> CreativeModeTab.builder()
                    .icon(() -> new ItemStack(ModBlocks.ICE_SHARD_ORE.get()))
                    .title(Component.translatable("itemGroup.ore_tab"))
                    .displayItems((pParameters, pOutput) -> {
                        pOutput.accept(ModBlocks.ICE_SHARD_ORE.get());
                        pOutput.accept(ModBlocks.LAVA_SHARD_ORE.get());
                        pOutput.accept(ModItems.Ice_Shard.get());
                        pOutput.accept(ModItems.Lava_Shard.get());
                    }).build());
